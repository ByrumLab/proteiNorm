...
pdf("figures/barplot.pdf", width = 7, height = 7)
par(mar=c(12,8,3,0))
...
ggplot2::autoplot(pca, data = meta, colour = "Group", x = 1, y = 2, label  = TRUE, xlim = c(-0.4,0.4), main = "PCA")
dev.off()



pdf("figures/pcv.pdf", width = 7, height = 7)
par(mar=c(10,6,3,1))
...
pdf("figures/pmad.pdf", width = 7, height = 7)
par(mar=c(10,6,3,1))
...
pdf("figures/pev.pdf", width = 7, height = 7)
par(mar=c(10,6,3,1))
...
pdf("figures/cor.pdf", width = 7, height = 7)
par(mar=c(10,6,3,1))
...
pdf("figures/naHM.pdf", width = 10, height = 28)
data = normList[["Log2"]]
...
pdf("figures/corHM.pdf", width = 8.25, height = 7)
heatmapCorr(normList[[i]], groups, batch, sampleLabels)
dev.off()


pdf("figures/log2ratio.pdf", width = 7, height = 7)
par(mar=c(5,4,1,1))
